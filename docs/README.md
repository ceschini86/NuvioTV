...
|-------------|--------|-------------------|
| **Handoff overlay Info-rail (A–D + bugs Info 1.0.8)** | [`handoff/2026-09-24-overlay-info-rail-close.md`](./handoff/2026-09-24-overlay-info-rail-close.md) | 1.0.8: erros Info amigáveis; restore fonte no click IA; Info addon sem Degrau AI |
