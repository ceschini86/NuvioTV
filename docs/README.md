...
**Estado (2026-09-23):** código presente neste working tree na branch `fix/ai-ladder-and-rate-limit` (base `release/1.0.2`). Ainda pode estar ausente em `dev` até merge.
